...
const loginPayLoad = {
  userEmail: "sabir000@gmail.com",
  userPassword: "AbrarSabir1",
};
const orderPayLoad = {
  orders: [{ country: "Norway", productOrderedId: "67a8dde5c0d3e6622a297cc8" }],
};
...
test.only("Verify order is showing in order history page", async ({ page }) => {
